...
<div class="container container-custom mb-2"> <h2><b>All Games</b></h2><hr> </div>
    ...
    <div class="col-md-6 col-lg-3 my-0 mx-0" style="padding:0px;">
        <div class="card mb-0" style="height:390px;border:none;" >
                ...
                <div class="card-body">
                    ...
                    <form action="/admin/edit/game/{{$all -> id}}" method="GET" style="positiotn:relative;float:left;">
                    @csrf
                    <button class="btn btn-custom2 btn-danger" >Edit</button>
                    </form>
                    
                    <form action="/admin/games/{{$all -> id}}" method="POST" style="positiotn:relative;float:left;">
                    @csrf
                    @method('DELETE')
