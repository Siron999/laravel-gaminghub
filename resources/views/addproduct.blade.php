...
<br/>
<form action="{{ route('upload.post.product') }}" method="POST" enctype="multipart/form-data" >
    @csrf
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <textarea type="text" class="form-control" id="name" placeholder="Details" name="details" style="height:150px;"></textarea>
    </div>
  </div>
  <div class="form-group row">
